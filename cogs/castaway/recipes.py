...
class CopperAxe(world.CraftedResource):
    recipe = {world.Copper: 3, world.Stick: 2}
...
class CopperShovel(world.CraftedResource):
    recipe = {world.Copper: 1, world.Stick: 2}
...
class LargeStorage(world.CraftedResource):
    recipe = {BundledLogs: 25, world.Copper: 10}
...
class WaterPurifier(world.CraftedResource):
    recipe = {world.Rock: 2, BundledLogs: 3, world.Copper: 10}
...
class Boat(world.CraftedResource):
    recipe = {BundledLogs: 250, world.Wood: 250, Sail: 5, world.Iron: 50}
...
class Trap(world.CraftedResource):
    recipe = {world.Leaves: 25, world.Wood: 10, world.String: 25}
